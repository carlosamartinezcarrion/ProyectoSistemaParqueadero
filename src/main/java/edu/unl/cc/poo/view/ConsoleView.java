...
/**
 * Maneja toda la presentación en consola del sistema de parqueadero.
 */
public class ConsoleView {
    ...
    public void mostrarRegistroEntrada(Registro registro) {
        ...
        System.out.println("Entrada: " + registro.getFechaHoraEntrada());
    ...
    public void mostrarRegistroSalida(Registro registro) {
        ...
        System.out.println("Tipo: " + registro.getVehiculo().getTipo());
        System.out.println("Entrada: " + registro.getFechaHoraEntrada());
        System.out.println("Salida: " + registro.getFechaHoraSalida());
